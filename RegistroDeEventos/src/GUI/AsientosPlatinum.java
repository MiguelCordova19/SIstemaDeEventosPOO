...
public class AsientosPlatinum extends javax.swing.JFrame {
    private SistemaPago sistemaPago;

    public AsientosPlatinum() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Asientos Platinum");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsientosPlatinum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AsientosPlatinum().setVisible(true);
            }
        });
    }
