...
public class AsientosGeneral extends javax.swing.JFrame {
    private SistemaPago sistemaPago;

    public AsientosGeneral() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Asientos General");
    ...
    private void btnNextPagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextPagarActionPerformed
        ...
        if (asientos != null) {
            for (int numAsiento : asientos) {
                ...
                sistemaPago.agregarAsientoSeleccionado(numAsientoStr, 80.0, "General");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsientosGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AsientosGeneral().setVisible(true);
            }
        });
    }
